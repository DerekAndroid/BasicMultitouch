...
public class TouchDisplayView extends View {
    public static final String TAG = "TouchDisplayView";
    TextView setMaxTouchCountTextView;
    TextView currentTouchCountTextView;
    TextView setTimeoutTextView;
    ...
    public void bindShowInfoViews(TextView setMaxTouchCountTextView,
                          TextView currentTouchCountTextView,
                          TextView setTimeoutTextView,
                          TextView currentTimeTextView){
        this.setMaxTouchCountTextView = setMaxTouchCountTextView;
        this.currentTouchCountTextView = currentTouchCountTextView;
        this.setTimeoutTextView = setTimeoutTextView;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getPointerCount() > maxTouchCount) {
            //DKLog.d(TAG, Trace.getCurrentMethod() + event.getPointerCount());
            maxTouchCount = event.getPointerCount();
            currentTouchCountTextView.setText(String.valueOf(maxTouchCount));

            if(callback != null){
                callback.result(maxTouchCount);
            }
        }
        /*
    ...
    private void initialisePaint() {
        ...
        mCircleRadius = CIRCLE_RADIUS_DP * density / 2;
